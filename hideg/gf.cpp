...
string g_ver = "gf, v1.5.1b, Oleg Mazonka 2022-2023";
...
try
{
    // validate hash function
    {
        ...
        string sha256_2 = "0841ea62d9232a98182d4125fc05cc900721f0b303549d552a96bd99a451c447";
        string S00(500, '0');
        if ( ha::hashHex(S00) != sha256_2 ) nevers("bad hashing");
    }
