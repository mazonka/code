...
void replacebuf(int frsz, string to)
{
    int sz = to.size();
    for ( int i = 0; i < frsz; i++ ) buf.pop_back();
...
int main(int ac, char * av[])
{
    ...
    if ( fr.size() != to.size() )
    {
        cout << "Warning: Contents of to-replace and replacement have different sizes\n";
        //return 3;
    }
    ...
    cout << "Number of replacement: " << cnt << '\n';
}
